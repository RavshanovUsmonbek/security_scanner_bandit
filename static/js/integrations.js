...
>
    ...
    methods: {
        ...
        handleEdit(data) {
            console.debug('bandit editIntegration', data)
                ...
                response.json().then(
                    errorData => {
                        errorData.forEach(item => {
                            console.debug('bandit item error', item)
        ...
        initialState: () => ({
            ...
            pluginName: 'security_scanner_bandit',
...
register_component('banditIntegration', banditIntegration)
